...
public class AccountController {
	...
	public List<Account> getAllAccounts(@RequestParam("uuid") String uuid) {
	...
	public Account getAccountbySeries(@RequestParam("uuid") String uuid, @RequestParam("series") String series) {
		if (!sessionService.isSessionValid(uuid)) {
			throw new ExpiredSessionException("Session has expired");
		}
		long userId = sessionService.getSessionUserID(uuid);
